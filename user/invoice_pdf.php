    ...
    <div class="container">
        ...
        <div class="bill-section">
            <div class="bill-item">
                ...
                <p>Address: ' . htmlspecialchars($booking['customer_address'] ?? '-') . '</p>
            </div>
            <div class="bill-item">
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <small>Booking Date: ' . formatDate($booking['booking_date']) . '</small>
                    </td>
        ...
        <div class="status-row">
            ...
            <div class="status-item">
                ...
                <div class="status-badge">' . ($booking['status'] === 'completed' ? 'Paid' : 'Pending') . '</div>
            </div>
        </div>

        <div class="footer">
            <p>Thank you for using Astra Service. For queries, contact us at support@astraservice.com</p>
